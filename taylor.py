'''
This code is available in Bokeh Tutorial:
https://github.com/bokeh/bokeh/blob/master/examples/app/taylor.py

I merely just copied this code here for the purpose of demo.
I lay no claim to anything anything in this code.
